...
Bash
apt update && apt install -y wget && wget -O vps_setup.sh https://raw.githubusercontent.com/sakuranano/vps_setup/main/vps_setup.sh && chmod +x vps_setup.sh && ./vps_setup.sh
...
依赖管理：自动安装常用运维工具 (curl, wget, git, htop, vim, lsof, jq 等)。
